---
name: orchestrator
display-name: Orchestrator (mcp-vertex)
icon: $(tools)
model: MiniMax M3 (minimax)
description: |
    Root orchestrator for @export-to-postman/core. The real contract lives in the project bootstrap (docs/mcp-vertex/AGENT-BOOTSTRAP.md) and the mcp-vertex MCP server.
user-invocable: true
---
