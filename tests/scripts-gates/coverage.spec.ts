...
describe("coverage gate", () => {
  ...
  test("rejects missing profiles and metrics below threshold", () => {
    ...
    expect(evaluateCoverage(summary, baseline)).toEqual([
      "coverage — core.lines 89% retrocedió del baseline 90% (tol 0.5)",
      "coverage — core.statements 89% retrocedió del baseline 90% (tol 0.5)",
      "coverage — core.functions 89% retrocedió del baseline 90% (tol 0.5)",
      "coverage — core.branches 89% retrocedió del baseline 90% (tol 0.5)",
