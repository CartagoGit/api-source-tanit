...
const ROOT = resolve(moduleDir(import.meta.url), "../../tests/smoke-fixtures/django-mini");
const COMPREHENSIVE = resolve(moduleDir(import.meta.url), "../../tests/fixtures/django-comprehensive");
