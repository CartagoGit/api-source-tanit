...
description: Bounded subagent for @postman-exporter/core. The real contract lives in the mcp-vertex MCP server — use for any non-trivial change (more than 3 tool calls, multiple files, or repeated MCP reads).
---

# TechnicalInvestigator (mcp-vertex)
