 ...
 *
 * Alcance: `packages/plugins/delendai_tanit/**\/src/lib/tools/**\/*.ts`. Los servicios SÍ pueden
...
const TOOLS_GLOB_ROOT = resolve(REPO_ROOT, "packages/plugins/delendai_tanit");
...
const PERMITIDOS: Readonly<Record<string, string>> = {
  "packages/plugins/delendai_tanit/src/lib/contracts/constants/runner-snapshot.constant.ts":
...
async function main(): Promise<number> {
  ...
  if (files.length === 0) {
    console.log("lint:tools — no se encontró ningún *.tool.ts / *.helper.ts bajo packages/plugins/delendai_tanit/src/lib/");
    return 0;
  }
