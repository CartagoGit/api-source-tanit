...
La dependencia local de `@mcp-vertex/core` queda fuera y sigue bloqueada en `p00007` (paquete sin publicar).
...
- Referencias obsoletas de `p00007` (`plugins/postman-exporter/…` → `packages/plugins/mcp-vertex_expostman/…`) corregidas.
