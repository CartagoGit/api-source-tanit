...
- **B-09** MCP dependency `file:../delendai/...`: vive en `p00007 blocked`.
  Depende de publicar `@delendai/core`.
...
| B-09 | MCP dependency `file:../../../../delendai/...` sigue en config; `p00007` blocked | `package.json#workspaces`, `.mcp.json` | P0 | a00008 |
...
- **Plugin MCP dependencia externa (`file:../delendai/...`)** — vive
  en `p00007 blocked` y depende de que se publique `@delendai/core`.
