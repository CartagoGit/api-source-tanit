...
- **Verificación independiente**: 4,5/10 (CI bloqueada por la
  dependencia `file:../delendai/...`, fuera del scope de este pase).
...
### 🟡 17. CI bloqueada por `delendai` sibling path (fuera de scope aquí)
...
- **CI `delendai` sibling path** — vive en `p00007 blocked`.
