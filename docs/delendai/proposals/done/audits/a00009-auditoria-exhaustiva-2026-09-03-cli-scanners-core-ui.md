...
- TEST-004/005/006/007 — siguen abiertos; viven como issues en
  `docs/delendai/issues/` por crear.
...
- **Dónde**: `packages/plugins/delendai_expostman/package.json:22`,
  `packages/plugins/delendai_expostman/tsconfig.json:14`
...
- **Dónde**: `packages/plugins/delendai_expostman/src/lib/tools/validate.tool.ts:96-98`
...
- **Dónde**:
  `packages/plugins/delendai_expostman/src/lib/helpers/runner.helper.ts:77,104,134,142,148,218,237`
...
- **Dónde**:
  `packages/plugins/delendai_expostman/src/lib/contracts/namespace.ts:18`
