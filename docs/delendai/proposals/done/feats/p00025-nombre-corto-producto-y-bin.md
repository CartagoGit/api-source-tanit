...
> entrypoint). El plugin de delendai toma el mismo nombre, así que
> sus tools pasan de `delendai_export-to-postman_generate` a
...
- Resolver el publish de `@delendai/cli` (p00007); solo alinear docs.
...
- **Files**:
  - `docs/delendai/proposals/done/feats/p00025-nombre-corto-producto-y-bin.md`
