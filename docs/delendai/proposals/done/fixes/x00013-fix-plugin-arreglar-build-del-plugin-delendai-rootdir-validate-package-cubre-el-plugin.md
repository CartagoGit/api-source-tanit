---
id: x00013
title: "fix(plugin): arreglar build del plugin delendai (rootDir + validate:package cubre el plugin)"
kind: fix
status: done
type: proposal
...
- [x] `bun run --cwd packages/plugins/delendai_expostman build` produce `dist/index.js`.
