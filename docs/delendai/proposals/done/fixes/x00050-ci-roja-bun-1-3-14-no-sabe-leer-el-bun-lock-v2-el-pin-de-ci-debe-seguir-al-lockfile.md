...
run del SHA shippedIn `9043822` muestra `Install dependencies` ✅
en `bun 1.4.2` (lee lockfile v2), mientras los runs previos a
este pin morían en `UnknownLockfileVersion`. La cadena completa
verde de CI es producto acumulado de varias propuestas
posteriores (x00045, x00046, x00053, etc.); no es evidencia
