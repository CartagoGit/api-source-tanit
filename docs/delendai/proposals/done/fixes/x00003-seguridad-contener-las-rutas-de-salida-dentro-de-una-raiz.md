...
- **Status**: done
- **DependsOn**: [S1]
- **Files**: `packages/core/discovery/paths.service.ts`, `packages/plugins/delendai_expostman/src/lib/helpers/runner.helper.ts`, `tests/core/output-containment.spec.ts`
- **Gate**: e2e
- acceptance:
