...
- **Status**: done
- **Files**: `packages/core/contracts/postman.d.ts`, `packages/core/helpers/collection-identity.helper.ts`, `packages/plugins/delendai_expostman/src/lib/helpers/runner.helper.ts`
- **Gate**: type
- acceptance:
