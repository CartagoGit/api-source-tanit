...
dependsOn:
  - a00018
shippedIn:
  - 171f6ad  # S1 contract + scanners (incl. request-doc.service.ts S2 Postman block)
  - c3f92d7  # S3 + S4 OpenAPI x-tanit-confidence extension + tests
last-transition-id: 4c66ceaf-4cb6-4b3c-9d2b-0f7d7a72d8a1
last-correlation-id: 4c66ceaf-4cb6-4b3c-9d2b-0f7d7a72d8a1
last-transition-from: ready
deviation: "NestJS @Body() any detector (S1 sub-acceptance) deferred — not implemented in nestjs.scanner.ts. Pages Router multi-verb case deviates from the proposal text: emits N endpoints per verb with low confidence instead of collapsing to a single method: ALL endpoint. Functionally equivalent and reversible later."
---
