...
- **Status**: done
- **Files**: `docs/delendai/AGENT-BOOTSTRAP.md`, `packages/plugins/delendai_expostman/src/lib/contracts/namespace.ts`
- **Gate**: lint
- acceptance:
...
- acceptance:
  ...
  - "`delendai_overview` devuelve `configIssues` vacío"
...
- **Status**: done
- **Files**: `docs/delendai/proposals/README.md`, `.gitignore`
- **Gate**: none
- acceptance:
