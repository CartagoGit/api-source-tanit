...
El acceptance final no es local: es `gh run list` sobre el HEAD
posterior mostrando la CI verde por primera vez desde que el
lockfile subió a v2. También desbloquea la evidencia empírica de
x00045 (validate sin Delendai) y x00046 (multi-service E2E sin
skip) — hasta ahora verificadas sólo en local.