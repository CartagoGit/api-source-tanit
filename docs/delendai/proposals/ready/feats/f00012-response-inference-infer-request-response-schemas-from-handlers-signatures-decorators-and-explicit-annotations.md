...
dependsOn:
  ...
  - r00016
shippedIn:
  - 2b8ea3d  # S1 contract + dispatcher
  - f000bc0  # S2 NestJS inferrer
  - 2e596ff  # S3 FastAPI inferrer
  - 243ef07  # S4 Spring + ASP.NET inferrers (bonus) + OpenAPI rendering
  - 68a8e87  # response-inferrers.ts barrel + CLI wiring + openapi.spec emit
  - cbe9b19  # OpenAPI emit reach production (no infinite loop)
last-transition-id: 8d2a1f7c-9e3b-4a6f-b5d8-7c1e0f9a2b3d
last-correlation-id: 8d2a1f7c-9e3b-4a6f-b5d8-7c1e0f9a2b3d
last-transition-from: ready
deviation: "S4 Postman exporter side not implemented: postman.exporter.ts does not read EndpointSpec.responses and does not emit response[] blocks. The OpenAPI side IS implemented (renderInferredResponses in openapi.exporter.ts). Postman gap will be closed via a follow-up proposal (f00014) so this proposal's S4 acceptance is partially met."
---
